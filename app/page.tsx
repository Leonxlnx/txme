  ...
  return (
    <div className="relative bg-black">
      ...
      <div className="relative h-screen w-screen overflow-hidden">
        ...
        {/* 185deg = very subtle 5° diagonal */}
        <div
          className="pointer-events-none absolute bottom-0 inset-x-0 z-20 h-[70vh]"
          style={{
            background: "linear-gradient(185deg, transparent 59%, rgba(0,0,0,0.15) 65%, rgba(0,0,0,0.4) 72%, rgba(0,0,0,0.75) 80%, black 90%)",
          }}
        />
        {/* Pixelated + grid along the diagonal */}
        <div
          className="pointer-events-none absolute bottom-0 inset-x-0 z-20 h-[70vh] select-none"
          style={{
            ...
            maskImage: "linear-gradient(185deg, transparent 61%, rgba(0,0,0,0.5) 68%, rgba(0,0,0,0.3) 76%, transparent 85%)",
            WebkitMaskImage: "linear-gradient(185deg, transparent 61%, rgba(0,0,0,0.5) 68%, rgba(0,0,0,0.3) 76%, transparent 85%)",
          }}
        />
      </div>
