        ...
        <div className="flex flex-col items-center justify-center flex-1 relative">
            ...
            <span className="group/pill relative inline-block rounded-full p-[1px] transition-all duration-500 pointer-events-auto cursor-default">
              ...
              <span
                ...
                style={{
                  ...
                  background: "linear-gradient(135deg, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.03) 100%), rgba(10,10,12,0.65)",
          ...
          >
            ...
            <button
              ...
              style={{
                fontFamily: "var(--font-space)",
                background: "linear-gradient(135deg, rgba(255,255,255,0.06) 0%, rgba(255,255,255,0.02) 100%), rgba(10,10,12,0.6)",
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.background = "linear-gradient(135deg, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0.04) 100%), rgba(10,10,12,0.6)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = "rgba(255,255,255,0.12)";
                e.currentTarget.style.boxShadow = "inset 0 1px 0 rgba(255,255,255,0.06)";
                e.currentTarget.style.background = "linear-gradient(135deg, rgba(255,255,255,0.06) 0%, rgba(255,255,255,0.02) 100%), rgba(10,10,12,0.6)";
              }}
            >
              {/* Shine sweep */}
